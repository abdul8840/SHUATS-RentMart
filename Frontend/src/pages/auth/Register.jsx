...
import {
  ...
  FiUserPlus, FiEye, FiEyeOff, FiCheckCircle,
  FiShield, FiAward, FiBookOpen
} from 'react-icons/fi';
...
const perks = [
  { icon: <FiShield size={16} />, title: 'Verified Students Only', desc: 'Safe & trusted community' },
  { icon: <FiBookOpen size={16} />, title: 'Campus Resources', desc: 'Books, notes & equipment' },
  { icon: <FiAward size={16} />, title: 'Trust Score System', desc: 'Build your reputation' },
];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await registerAPI({
        ...
        semester: parseInt(formData.semester), idCardImage,
      });
      if (data.success) {
        ...
        <div className="relative z-10 text-white text-center max-w-sm">
          ...
          <div className="flex items-center justify-center gap-3 mb-8 animate-slide-down">
            ...
            <div className="text-left">
              ...
              <p className="text-[var(--color-mint-light)] text-xs">Campus Marketplace</p>
            </div>
          </div>
          ...
          ">
            ...
            <div className="absolute top-2 right-2 text-xl animate-bounce-soft" style={{ animationDelay: '0.3s' }}>📖</div>
            <div className="absolute bottom-2 left-2 text-xl animate-bounce-soft" style={{ animationDelay: '0.6s' }}>💻</div>
            <div className="absolute top-2 left-3 text-lg animate-bounce-soft" style={{ animationDelay: '0.9s' }}>🔬</div>
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent" />
          </div>

          <h2 className="text-xl font-extrabold mb-2 animate-slide-up" style={{ animationDelay: '100ms' }}>
            Join Your Campus Community
          </h2>
          <p className="text-sm text-[var(--color-mint-light)] mb-6 animate-slide-up" style={{ animationDelay: '150ms' }}>
            ...
            {perks.map((p, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[var(--color-mint-light)] text-[11px]">{p.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="w-full max-w-xl px-6 sm:px-10 py-8">
          ...
          ">
            ...
            <div className="p-6 sm:p-8">
              <div className="mb-6">
                <h2 className="text-2xl font-extrabold text-gray-800 mb-1">Student Registration 🎓</h2>
                <p className="text-sm text-gray-500">Create your account using your SHUATS credentials</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-1 ml-1">
                    ⓘ Only @shiats.com or @shuats.com emails are accepted
                  </p>
                </div>
                ...
                <div className="pt-1">
                  ...
                  ">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-sm font-bold text-gray-800">Student ID Card</p>
              ...
              <p className="text-center text-sm text-gray-500 mt-5">
                ...
                <Link to="/login" className="font-bold text-[var(--color-forest)] hover:underline underline-offset-2 cursor-pointer">
                  Login here
                </Link>
              </p>
            </div>
