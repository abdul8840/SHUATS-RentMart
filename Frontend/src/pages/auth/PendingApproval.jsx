  ...
  return (
    <div className="min-h-screen bg-[var(--color-cream-light)] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div
          className="absolute -bottom-32 -right-32 w-96 h-96 rounded-full bg-[var(--color-mint-light)] opacity-30 blur-3xl animate-pulse-soft"
          ...
          <div className="p-8 text-center">
            ...
            {isPending ? (
              <div className="flex flex-col items-center gap-4 mb-6 animate-slide-down">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed max-w-xs">
                    Your email is verified ✅. Our admin team is now verifying
                    your SHUATS Student ID card. You'll receive an email once
                    approved.
                  </p>
                </div>
                ...
                <div className="w-full space-y-3 text-left mt-2">
                  {[
                    ...
                    },
                    {
                      ...
                      label: 'ID card under review',
                      done: false,
                      active: true
                    },
                    {
                      icon: <FiMail size={16} />,
                      label: 'Approval email will be sent',
                      done: false
                    }
                  ].map((step, i) => (
                    <div
                ...
                >
                  <FiClock
                    size={14}
                    className="text-[var(--color-forest)] flex-shrink-0"
                  />
              ...
              <div className="flex flex-col items-center gap-4 mb-6 animate-slide-down">
                ...
                "
                >
                  <p className="text-xs font-semibold text-[var(--color-forest)] mb-1">
                    Need help?
                  </p>
                  <p className="text-xs text-gray-600">
                    Contact us at{' '}
                    <a
                      href="mailto:support@shuats.edu.in"
                      className="text-[var(--color-forest)] font-semibold hover:underline cursor-pointer"
                    >
                      support@shuats.edu.in
                    </a>
                  </p>
                </div>
              </div>
